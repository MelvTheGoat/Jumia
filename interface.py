...
st.title("🛍️ Jumia Product Sentiment Dashboard")
...
#     else:
#         st.error("Model files not found! Make sure 'logistic_model.pkl' and 'tfidf_vectorizer.pkl' are in the same folder as app.py.")4